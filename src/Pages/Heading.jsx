...
const Heading = (props) => {
  return (
    <div className='z-50 w-full flex flex-col items-center justify-center gap-4 cursor-default group transition-all ease-in-out duration-1000 mb-10 md:mb-20'>
        <div className='text-3xl md:text-4xl font-bold tracking-wide uppercase bg-gradient-to-r dark:from-neonFade dark:to-purple-800 from-neonDark to-purple-800 bg-clip-text text-transparent noto'>{props?.title}</div>
